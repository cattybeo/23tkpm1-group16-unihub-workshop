-- Add students.is_active gate to registration RPC.
-- Raises STUDENT_NOT_VERIFIED when mssv is missing or has been soft-deleted
-- by the nightly CSV sync (is_active = false).
